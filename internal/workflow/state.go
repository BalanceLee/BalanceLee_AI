...
func init() {
	schema.RegisterName[*WorkflowLocalState]("_balancelee_workflow_local_state")
	schema.RegisterName[NodeOutputEnvelope]("_balancelee_workflow_node_output_envelope")
	schema.RegisterName[StartOutput]("_balancelee_workflow_start_output")
	schema.RegisterName[ConditionOutput]("_balancelee_workflow_condition_output")
	schema.RegisterName[ToolOutput]("_balancelee_workflow_tool_output")
	schema.RegisterName[AgentOutput]("_balancelee_workflow_agent_output")
	schema.RegisterName[HITLOutput]("_balancelee_workflow_hitl_output")
	schema.RegisterName[OutputNodeOutput]("_balancelee_workflow_output_node_output")
}
