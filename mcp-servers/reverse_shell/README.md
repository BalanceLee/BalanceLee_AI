...
Add **reverse shell** capability to BalanceLeeAI via External MCP: start/stop a TCP listener and run commands on connected targets—no backend code changes required.
...
1. **Paths**  
   ...
   Script: `/path/to/BalanceLeeAI-main/mcp-servers/reverse_shell/mcp_reverse_shell.py`
...
```json
{
  "reverse-shell": {
    ...
    "args": ["/path/to/BalanceLeeAI-main/mcp-servers/reverse_shell/mcp_reverse_shell.py"],
