## BalanceLeeAI Burp Suite Extension
...
- Right-click any HTTP message in Burp and send it to BalanceLeeAI for **streaming web pentest** (agent modes: **Eino Single**, Deep, Plan-Execute, Supervisor — maps to `/api/eino-agent/stream` or `/api/multi-agent/stream`)
