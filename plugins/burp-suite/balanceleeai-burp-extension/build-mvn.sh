...
if command -v mvn >/dev/null 2>&1; then
  ...
  MAVEN_VERSION="3.9.6"
  BASE_DIR="${HOME}/.cache/balanceleeai-burp-extension"
...
cp "$ROOT_DIR/target/balanceleeai-burp-extension-1.0.0.jar" "$DIST_DIR/balanceleeai-burp-extension.jar"
echo "[+] Done: $DIST_DIR/balanceleeai-burp-extension.jar"
