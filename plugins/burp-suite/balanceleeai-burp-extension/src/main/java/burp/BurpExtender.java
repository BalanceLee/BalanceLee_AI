...
public class BurpExtender implements IBurpExtender, IContextMenuFactory {
    ...
    private BalanceLeeAITab tab;
    private final BalanceLeeAIClient client = new BalanceLeeAIClient();
    ...
    public void registerExtenderCallbacks(IBurpExtenderCallbacks callbacks) {
        ...
        callbacks.setExtensionName("BalanceLeeAI Extension");

        this.tab = new BalanceLeeAITab();
        callbacks.addSuiteTab(tab);

        callbacks.registerContextMenuFactory(this);

        callbacks.printOutput("BalanceLeeAI extension loaded.");
    }
    ...
    public List<JMenuItem> createMenuItems(IContextMenuInvocation invocation) {
        ...
        JMenuItem sendItem = new JMenuItem("Send to BalanceLeeAI (stream test)");
    ...
    private void sendMessage(IHttpRequestResponse msg) {
        if (msg == null) return;
        BalanceLeeAIClient.Config cfg = tab.currentConfig();
        ...
        client.streamTest(cfg, token, prompt, options.role, options.projectId, options.agentMode,
                new BalanceLeeAIClient.StreamListener() {
            @Override
            ...
            public void onError(String message, Exception e) {
                ...
                callbacks.printError("BalanceLeeAI stream error: " + message);
                if (e != null) {
