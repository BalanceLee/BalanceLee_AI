...
async function loadConfig(loadTools = true, options = {}) {
    ...
    try {
        ...
        if (wechatBotAgent) wechatBotAgent.value = wechat.bot_agent || 'BalanceLeeAI/1.0';
        ...
        const config = {
            ...
            robots: {
                ...
                wechat: {
                    ...
                    bot_agent: document.getElementById('robot-wechat-bot-agent')?.value.trim() || 'BalanceLeeAI/1.0',
